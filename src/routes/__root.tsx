...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Posterwall — wallpaper generator" },
      {
        name: "description",
        content:
          "Turn a thought into a bold, premium, typography-first phone or desktop wallpaper.",
      },
      { name: "author", content: "Posterwall" },
      { property: "og:title", content: "Posterwall — wallpaper generator" },
      {
        property: "og:description",
        content: "Turn a thought into a bold, typography-first wallpaper.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Instrument+Serif:ital@0;1&family=Bricolage+Grotesque:opsz,wght@12..96,300..800&family=Inter:wght@300;400;500;600;700&family=Caveat:wght@400..700&family=Space+Grotesk:wght@400..700&family=Archivo+Black&family=Anton&family=Libre+Bodoni:ital,wght@0,400..700;1,400..700&family=Montserrat:wght@700;800;900&display=swap",
      },
    ],
  }),
